...
const { uploadOrdersFromExcel, viewAllOrders, getOrderPrice, getProductDetails, listShippingOptions, validateOrders, validateSubmitOrders, uploadOrdersToLocalDatabase, updateOrder } = require('./upload-orders'); 
...
app.post('/view-all-orders-outdated', viewAllOrders);
